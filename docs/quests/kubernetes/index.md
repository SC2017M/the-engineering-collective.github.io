# Kubernetes Engineer Quest

What makes a Kubernetes Engineer, or more importantly a _good_ Kubernetes Engineer? 

## Roadmap

![alt text](../../assets/img/kubernetes_path.png "Kubernetes Path")
